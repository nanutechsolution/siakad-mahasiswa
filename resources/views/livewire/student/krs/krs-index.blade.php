                        ...
                        @forelse($available_classes as $class)
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    ...
                                    @if ($class->course->prerequisites->count() > 0)
                                        <div
                                            class="mt-1 flex items-center gap-1.5 text-[10px] font-bold text-orange-600 dark:text-orange-400 uppercase tracking-tighter">
                                            ...
                                            Prasyarat:
                                            @foreach ($class->course->prerequisites as $p)
                                                <span
                                                    class="underline">{{ $p->code }}</span>{{ !$loop->last ? ',' : '' }}
                                            @endforeach
                                        </div>
                                    @endif
