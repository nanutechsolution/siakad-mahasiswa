    ...
    <body>
        ...
        <div class="header">
            ...
            <div class="kop-text">
                ...
                <div class="kop-fakultas">{{ $student->studyProgram->faculty->name ?? 'FAKULTAS SAINS DAN TEKNOLOGI' }}</div>
        ...
        <table class="tabel-krs">
            ...
            <tbody>
                ...
                @php $bobot_total = $item->courseClass->course->credit_total * $item->grade_point; @endphp
                <tr>
                    <td>{{ $index + 1 }}</td>
                    <td>{{ $item->courseClass->course->code }}</td>
                    <td class="left">{{ $item->courseClass->course->name }}</td>
                    <td>{{ $item->courseClass->course->credit_total }}</td>
        ...
        <div class="footer">
            <div class="ttd-box">
                ...
                <strong>{{ $student->studyProgram->head_name ?? '(......................)' }}</strong><br>
                NIDN. {{ $student->studyProgram->head_nip ?? '................' }}
            </div>
        </div>
    </body>
