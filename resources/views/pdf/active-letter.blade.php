    ...
    <div class="content">
        ...
        <table class="table-info">
            <tr>
                <td width="30%">Nama</td>
                <td width="5%">:</td>
                <!-- Menggunakan data Kaprodi dari tabel StudyProgram -->
        ...
        <p class="text-justify">
            Adalah benar mahasiswa yang bersangkutan berstatus <strong>AKTIF</strong> pada Semester {{ $period->name }} Tahun Akademik {{ substr($period->code ?? date('Y'), 0, 4) }}/{{ substr($period->code ?? date('Y'), 0, 4) + 1 }} di lingkungan {{ $setting->campus_name }}.
        </p>
